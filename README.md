...
The pretrained models can be downloaded from [Google Drive](https://drive.google.com/file/d/1eAch0P2o_YW8G2Cl5H1tWnMUMw5yboqG/view?usp=sharing). To evaluate the pretrained models, you need to copy all the files in one of the seed folder (need to be consistent with the SEED parameter) into models/, and run the evaluation script:
