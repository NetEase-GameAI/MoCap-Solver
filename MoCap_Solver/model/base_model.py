...
class BaseModel(ABC):
    ...
    def __init__(self, args):
        ...
        self.model_save_dir = os.path.join(args.save_dir)  # save all the checkpoints to save_dir

        if self.is_train:
            from MoCap_Solver.model.loss_record import LossRecorder
            from torch.utils.tensorboard import SummaryWriter
            self.log_path = os.path.join(args.save_dir, 'logs2')
    ...
    def get_scheduler(self, optimizer):
        ...
        if self.args.scheduler == 'Step_LR':
            ...
            return torch.optim.lr_scheduler.StepLR(optimizer, 50, 0.9)
