...
import numpy as np
'''
This script contains the operations on skeletons, including SkeletonConv, SkeletonLinear, SkeletonPool, SkeletonUnPool

This script is borrowed from [Aberman et al. 2020].
'''
